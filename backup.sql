...
--
-- Name: attendance_asistencia; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.attendance_asistencia (
    id bigint NOT NULL,
    fecha date NOT NULL,
    ...
    profesor_registro_id integer
);


ALTER TABLE public.attendance_asistencia OWNER TO postgres;

--
-- Name: attendance_asistencia_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.attendance_asistencia ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.attendance_asistencia_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: courses_alumno; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.courses_alumno (
    id bigint NOT NULL,
    ...
    edad smallint,
    CONSTRAINT courses_alumno_edad_check CHECK ((edad >= 0))
);


ALTER TABLE public.courses_alumno OWNER TO postgres;

--
-- Name: courses_alumno_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.courses_alumno ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.courses_alumno_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: courses_asignacionalumno; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.courses_asignacionalumno (
    id bigint NOT NULL,
...
ALTER TABLE public.courses_asignacionalumno OWNER TO postgres;

--
-- Name: courses_asignacionalumno_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.courses_asignacionalumno ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.courses_asignacionalumno_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: courses_horario; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.courses_horario (
    id bigint NOT NULL,
...
ALTER TABLE public.courses_horario OWNER TO postgres;

--
-- Name: courses_horario_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.courses_horario ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.courses_horario_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: users_profesorprofile; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.users_profesorprofile (
    id bigint NOT NULL,
...
ALTER TABLE public.users_profesorprofile OWNER TO postgres;

--
-- Name: users_profesorprofile_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.users_profesorprofile ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.users_profesorprofile_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: attendance_asistencia attendance_asistencia_alumno_id_horario_id_fecha_01d5bd8b_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_asistencia
    ADD CONSTRAINT attendance_asistencia_alumno_id_horario_id_fecha_01d5bd8b_uniq UNIQUE (alumno_id, horario_id, fecha);


--
-- Name: attendance_asistencia attendance_asistencia_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_asistencia
    ADD CONSTRAINT attendance_asistencia_pkey PRIMARY KEY (id);
...
--
-- Name: courses_alumno courses_alumno_correo_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_alumno
    ADD CONSTRAINT courses_alumno_correo_key UNIQUE (correo);


--
-- Name: courses_alumno courses_alumno_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_alumno
    ADD CONSTRAINT courses_alumno_pkey PRIMARY KEY (id);


--
-- Name: courses_alumno courses_alumno_rut_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_alumno
    ADD CONSTRAINT courses_alumno_rut_key UNIQUE (rut);


--
-- Name: courses_asignacionalumno courses_asignacionalumno_alumno_id_horario_id_1fc1537b_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_asignacionalumno
    ADD CONSTRAINT courses_asignacionalumno_alumno_id_horario_id_1fc1537b_uniq UNIQUE (alumno_id, horario_id);


--
-- Name: courses_asignacionalumno courses_asignacionalumno_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_asignacionalumno
    ADD CONSTRAINT courses_asignacionalumno_pkey PRIMARY KEY (id);
...
--
-- Name: courses_horario courses_horario_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_horario
    ADD CONSTRAINT courses_horario_pkey PRIMARY KEY (id);
...
--
-- Name: users_profesorprofile users_profesorprofile_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_profesorprofile
    ADD CONSTRAINT users_profesorprofile_pkey PRIMARY KEY (id);


--
-- Name: users_profesorprofile users_profesorprofile_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_profesorprofile
    ADD CONSTRAINT users_profesorprofile_user_id_key UNIQUE (user_id);


--
-- Name: attendance_asistencia_alumno_id_32250f2a; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX attendance_asistencia_alumno_id_32250f2a ON public.attendance_asistencia USING btree (alumno_id);


--
-- Name: attendance_asistencia_horario_id_8c5d277c; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX attendance_asistencia_horario_id_8c5d277c ON public.attendance_asistencia USING btree (horario_id);


--
-- Name: attendance_asistencia_profesor_registro_id_b656a87c; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX attendance_asistencia_profesor_registro_id_b656a87c ON public.attendance_asistencia USING btree (profesor_registro_id);
...
--
-- Name: courses_alumno_correo_ad6270a8_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_alumno_correo_ad6270a8_like ON public.courses_alumno USING btree (correo varchar_pattern_ops);


--
-- Name: courses_alumno_rut_ac74c3d8_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_alumno_rut_ac74c3d8_like ON public.courses_alumno USING btree (rut varchar_pattern_ops);


--
-- Name: courses_asignacionalumno_alumno_id_1545db93; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_asignacionalumno_alumno_id_1545db93 ON public.courses_asignacionalumno USING btree (alumno_id);


--
-- Name: courses_asignacionalumno_curso_id_335833cb; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_asignacionalumno_curso_id_335833cb ON public.courses_asignacionalumno USING btree (curso_id);


--
-- Name: courses_asignacionalumno_horario_id_8bc89273; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_asignacionalumno_horario_id_8bc89273 ON public.courses_asignacionalumno USING btree (horario_id);


--
-- Name: courses_horario_curso_id_cc1d0aed; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_horario_curso_id_cc1d0aed ON public.courses_horario USING btree (curso_id);


--
-- Name: courses_horario_profesor_id_9092e060; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX courses_horario_profesor_id_9092e060 ON public.courses_horario USING btree (profesor_id);
...
--
-- Name: attendance_asistencia attendance_asistenci_profesor_registro_id_b656a87c_fk_auth_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_asistencia
    ADD CONSTRAINT attendance_asistenci_profesor_registro_id_b656a87c_fk_auth_user FOREIGN KEY (profesor_registro_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: attendance_asistencia attendance_asistencia_alumno_id_32250f2a_fk_courses_alumno_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_asistencia
    ADD CONSTRAINT attendance_asistencia_alumno_id_32250f2a_fk_courses_alumno_id FOREIGN KEY (alumno_id) REFERENCES public.courses_alumno(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: attendance_asistencia attendance_asistencia_horario_id_8c5d277c_fk_courses_horario_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance_asistencia
    ADD CONSTRAINT attendance_asistencia_horario_id_8c5d277c_fk_courses_horario_id FOREIGN KEY (horario_id) REFERENCES public.courses_horario(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: courses_asignacionalumno courses_asignacional_alumno_id_1545db93_fk_courses_a; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_asignacionalumno
    ADD CONSTRAINT courses_asignacional_alumno_id_1545db93_fk_courses_a FOREIGN KEY (alumno_id) REFERENCES public.courses_alumno(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: courses_asignacionalumno courses_asignacional_horario_id_8bc89273_fk_courses_h; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_asignacionalumno
    ADD CONSTRAINT courses_asignacional_horario_id_8bc89273_fk_courses_h FOREIGN KEY (horario_id) REFERENCES public.courses_horario(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: courses_asignacionalumno courses_asignacionalumno_curso_id_335833cb_fk_courses_curso_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_asignacionalumno
    ADD CONSTRAINT courses_asignacionalumno_curso_id_335833cb_fk_courses_curso_id FOREIGN KEY (curso_id) REFERENCES public.courses_curso(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: courses_horario courses_horario_curso_id_cc1d0aed_fk_courses_curso_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_horario
    ADD CONSTRAINT courses_horario_curso_id_cc1d0aed_fk_courses_curso_id FOREIGN KEY (curso_id) REFERENCES public.courses_curso(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: courses_horario courses_horario_profesor_id_9092e060_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.courses_horario
    ADD CONSTRAINT courses_horario_profesor_id_9092e060_fk_auth_user_id FOREIGN KEY (profesor_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: users_profesorprofile users_profesorprofile_user_id_77d554fe_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.users_profesorprofile
    ADD CONSTRAINT users_profesorprofile_user_id_77d554fe_fk_auth_user_id FOREIGN KEY (user_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
